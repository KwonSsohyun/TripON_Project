...
<div class="sign">
	...
	<div class="id sign-inner-div sm-display-block-div" style="display: flex;">
		<label for="userid" class="col-3 inner-div-col"><span>* </span>아이디</label>
		<div style="display: flex" class="col-9 inner-div-col id-col">
			<input type="text" maxlength="10" class="valid-check sign-inner-input" name="mem_id" id="userid" placeholder="아이디를 입력해주세요.">
	...
	<div class="pw sign-inner-div sm-display-block-div" style="display: flex;">
		<label for="userpw" class="col-3 inner-div-col"><span>* </span>비밀번호</label>
		<div class="col-sm-9 inner-div-col">
			<input type="password" maxlength="15" class="valid-check sign-inner-input" name="mem_pw" id="userpw" placeholder="비밀번호를 입력해주세요.">
	...
	<div class="name sign-inner-div sm-display-block-div" style="display: flex;">
		<label for="username" class="col-3 inner-div-col"><span>* </span>이름</label>
		<div class="col-sm-9 inner-div-col">
			<input type="text" maxlength="10" class="valid-check sign-inner-input" name="mem_username" id="username" placeholder="이름을 입력해주세요.">
		</div>
	</div>
	
	<div class="subject_underline2"></div>
	
	<div class="nickname sign-inner-div sm-display-block-div" style="display: flex;">
		<label for="usernickname" class="col-3 inner-div-col"><span>* </span>닉네임</label>
		<div class="col-sm-9 inner-div-col">
			<input type="text" maxlength="10" class="valid-check sign-inner-input" name="mem_nickname" id="usernickname" placeholder="닉네임을 입력해주세요.">
		</div>
	</div>
	...
	<div class="phonenumber sign-inner-div sm-display-block-div" style="display:flex">
		...
		<div class="col-sm-9 inner-div-col">
			...
			<h4 class="description">*휴대폰 번호를 정확하게 입력하지 않을 경우 <span class="br-span"><br>&nbsp;</span> 회원 혜택이 제한될 수 있습니다.</h4>	
		</div>	
	</div>     

	<div class="subject_underline2"></div>

	<div class="email sign-inner-div sm-display-block-div" style="display: flex;">
		<label for="useremail" class="col-sm-3 inner-div-col"><span>* </span>이메일주소</label>
		<div class="col-sm-9 inner-div-col">
			<input type="email" maxlength="50" class="valid-check sign-inner-input" name="mem_email" id="useremail" placeholder="이메일주소를 입력해주세요.">
		</div>
	</div>
	
	<div class="subject_underline2"></div>
	
	<div class="address sign-inner-div sm-display-block-div" style="display: flex;">	
	    ...
	    <div class="col-sm-9 inner-div-col">
			...
			<div id="sample6_address_group">
				<input type="text" class="col-sm-12" name="mem_address_02" id="sample6_address" placeholder="우편번호주소" readonly>
				<input type="text" maxlength="50" class="col-sm-12" name="mem_address_03" id="sample6_detailAddress" placeholder="상세주소">
			</div>
	    </div>
	</div>
	...
	<div class="submit">
		...
		<input type="button" value="이전" onclick="history.go(-1);" style="background-color: #000000; margin-right: 10px;">
