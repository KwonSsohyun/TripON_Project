...
<div class="userUpdate">
	...
	<div class="pw update-inner-div sm-display-block-div" style="display: flex;">
		<label for="userpw" class="col-3 inner-div-col"><span>* </span>비밀번호</label>
		<div class="col-9 inner-div-col">
			<input type="password" maxlength="15" class="valid-check update-inner-input" name="mem_pw" id="userpw">
	...
	<div class="name update-inner-div sm-display-block-div" style="display: flex;">
		<label for="username" class="col-3 inner-div-col"><span>* </span>이름</label>
		<div class="col-9 inner-div-col">
			<input type="text" maxlength="10" class="valid-check update-inner-input" name="mem_username" id="username" value="${userOne.mem_username}">
		</div>
	</div>
	
	<div class="subject_underline"></div>
	
	<div class="nickname update-inner-div sm-display-block-div" style="display: flex;">
		<label for="usernickname" class="col-3 inner-div-col"><span>* </span>닉네임</label>
		<div class="col-9 inner-div-col">
			<input type="text" maxlength="10" class="valid-check update-inner-input" name="mem_nickname" id="usernickname" placeholder="닉네임" value="${userOne.mem_nickname}">
		</div>
	</div>
	
	<div class="subject_underline"></div>
	
	<div class="phonenumber update-inner-div sm-display-block-div" style="display:flex">
	...
	<div class="email update-inner-div sm-display-block-div" style="display: flex;">
		<label for="useremail" class="col-sm-3 inner-div-col"><span>* </span>이메일주소</label>
		<div class="col-9 inner-div-col">
			<input type="email" maxlength="50" class="valid-check update-inner-input" name="mem_email" id="useremail" value="${userOne.mem_email}">
		</div>
	</div>
	...
	<div class="address update-inner-div sm-display-block-div" style="display: flex;">	
	    ...
	    <div class="col-9 inner-div-col" style="width : 500px;">
			<div>
				...
				<input type="text" name="mem_address_01" id="sample6_postcode" value="<c:if test='${userOne.mem_address ne null }'>${fn:split(userOne.mem_address,',')[0]}</c:if>" placeholder="우편번호" readonly style="margin-left: 5px; width: 120px;">
			</div>
			<div>
				<input type="text" class="col-12" name="mem_address_02" id="sample6_address" value="<c:if test='${userOne.mem_address ne null }'>${fn:split(userOne.mem_address,',')[1]}</c:if>" placeholder="우편번호주소" readonly>
				<input type="text" maxlength="50" class="col-12" name="mem_address_03" id="sample6_detailAddress" value="<c:if test='${userOne.mem_address ne null }'>${fn:split(userOne.mem_address,',')[2]}</c:if>" placeholder="상세주소">
			</div>
	    </div>
	</div>
	...
	<div class="submit">
		<a href="userList"><input type="button" class="list-button" value="목록" style="background-color: #000000; margin-right: 5px;"></a>
