...
<div class="adminUpdate">
	...
	<div class="name update-inner-div sm-display-block-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<input type="text" maxlength="10" class="valid-check update-inner-input" name="mem_username" id="username" value="${adminOne.mem_username}">
		</div>
	</div>
	...
	<div class="nickname update-inner-div sm-display-block-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<input type="text" maxlength="10" class="valid-check update-inner-input" name="mem_nickname" id="usernickname" value="${adminOne.mem_nickname}">
		</div>
	</div>
	...
	<div class="email update-inner-div sm-display-block-div" style="display: flex;">
		...
		<div class="col-9 inner-div-col">
			<input type="email" maxlength="50" class="valid-check update-inner-input" name="mem_email" id="useremail" value="${adminOne.mem_email}">
		</div>
	</div>
	...
	<div class="address update-inner-div sm-display-block-div" style="display: flex;">	
	    ...
	    <div class="col-9 inner-div-col" style="width : 500px;">
			<div>
				...
				<input type="text" name="mem_address_01" id="sample6_postcode" value="<c:if test='${adminOne.mem_address ne null }'>${fn:split(adminOne.mem_address,',')[0]}</c:if>" placeholder="우편번호" readonly style="margin-left: 5px; width: 120px;">
			</div>
			<div>
				<input type="text" class="col-12" name="mem_address_02" id="sample6_address" value="<c:if test='${adminOne.mem_address ne null }'>${fn:split(adminOne.mem_address,',')[1]}</c:if>" placeholder="우편번호주소" readonly>
				<input type="text" maxlength="50" class="col-12" name="mem_address_03" id="sample6_detailAddress" value="<c:if test='${adminOne.mem_address ne null }'>${fn:split(adminOne.mem_address,',')[2]}</c:if>" placeholder="상세주소">
			</div>
	    </div>
	</div>
